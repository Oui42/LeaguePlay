...
if($__SETTINGS['active_register'] == 0) {
	alert("info", "Registration are currently not possible. Please try again later.");
} else {
	...
	<form method="post" action="" class="panel popup-panel">
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<input id="email" type="email" name="email" maxlength="64" placeholder="Type your email address...">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input id="passwordr" type="password" name="passwordr" maxlength="32" placeholder="Repeat your password...">
			</div>
			<div class="form-group">
				<input type="checkbox" id="rules" name="rules" value="1">
				<label for="rules">I have read <a href="index.php?app=main&module=main&section=rules">the rules</a> and agree to abide by them.</label>
			</div>
